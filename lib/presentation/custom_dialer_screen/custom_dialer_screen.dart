                        ...
                        children: [
                          Container(
                              ...
                              decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(100),
                                  color:
                                      controller.color.value.withOpacity(0.2)),
                              // color: ColorConstant.primaryWhiteBlue),
                              padding: EdgeInsets.all(10),
                              child: controller.callLogList[index].name!.isEmpty
                                  ? Icon(
                                      Icons.person,
                                  ...
                                  : Center(
                                      child: Text(
                                        controller
                                                .callLogList[index].name?[0] ??
                                            '',
                                        style: DL.styleDL(
                                            fontSize: 16,
                                            fontColor: controller.color.value,
                            ...
                            child: Column(
                              ...
                              children: [
                                  ...
                                  children: [
                                    Icon(
                                      controller.getIconData(controller
                                              .callLogList[index].callType ??
                                          CallType.outgoing),
                                      color: controller.getIconDataColor(
                                    ...
                                    Expanded(
                                      child: Text(
                                        controller.callLogList[index].name!
                                                .isEmpty
                                            ? controller.callLogList[index]
                                                    .number ??
                                                ''
                                ...
                                Text(
                                  ...
                                  overflow: TextOverflow.ellipsis,
                                  style: DL.styleDL(
                                      fontColor: ColorConstant.greyText),
                                ),
                              ],
                            ),
                          ),
